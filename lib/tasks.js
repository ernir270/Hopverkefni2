...
import { refreshTaskCounters } from './gets.js';
import { showEditTask } from './editTask.js';
 ...
 * @param {*} data 
 */
export function showTasks(data, editItemIndex){
    ...
    for(let i = 0; i < data.length; i++){
        ...
        input.addEventListener('click', () => completeTask(data[i]));
        ...
        section.addEventListener('click', () => showEditTask(data,i));
